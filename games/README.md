...
| [stack_blocks/](stack_blocks/) | 落ち物パズル「Stack Blocks」 | [stack_blocks/README.md](stack_blocks/README.md) |
...
| [bad_apple/](bad_apple/) | Bad Apple!! 動画再生（30 FPS ストリーム） | [bad_apple/README.md](bad_apple/README.md) |
...
| stack_blocks | `/games/stack_blocks/stack_blocks.lua` |
| stg | `/games/stg/stg.lua` + `img/*.bin`（任意） |
| stg_fast | `/games/stg_fast/stg_fast.lua` + `img/*.bin`（任意） |
| bad_apple | `/games/bad_apple/bad_apple.lua` + `frames.pack` |
