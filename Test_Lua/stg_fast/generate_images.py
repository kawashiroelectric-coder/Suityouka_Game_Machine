#!/usr/bin/env python3
"""
翠晶撃線 (stg_fast) 用 RGB565 スプライトとメニュープレビューを生成する。
...
出力:
  ...
  stg_fast.bin    … ゲーム選択メニュー用 100x100 プレビュー
"""
...
def main() -> None:
    ...
    print("Done. Copy stg_fast/ folder to SD:/games/stg_fast/")
